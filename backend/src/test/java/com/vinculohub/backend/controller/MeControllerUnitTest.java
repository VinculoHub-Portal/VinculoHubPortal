...
class MeControllerUnitTest {
    ...
    void shouldReturnEmptyProfileWhenUserNotFound() {
        ...
        AuthenticatedProfileResponse result =
                meController.profile(buildJwt("auth0|missing", "m@m.com"));
    ...
    void shouldReturnNpoIdForNpoUser() {
        ...
        AuthenticatedProfileResponse result =
                meController.profile(buildJwt("auth0|npo", "n@n.com"));
    ...
    void shouldReturnNullNpoIdWhenNpoNotRegistered() {
        ...
        AuthenticatedProfileResponse result =
                meController.profile(buildJwt("auth0|npo2", "n@n.com"));
    ...
    void shouldUseLegalNameWhenSocialNameIsNull() {
        ...
        AuthenticatedProfileResponse result =
                meController.profile(buildJwt("auth0|co2", "c@c.com"));
    ...
    void shouldUseLegalNameWhenSocialNameIsBlank() {
        ...
        AuthenticatedProfileResponse result =
                meController.profile(buildJwt("auth0|co3", "c@c.com"));
    ...
    @Test
    @DisplayName(
            "profile retorna companyId nulo quando empresa não encontrada para usuário company")
    void shouldReturnNullCompanyIdWhenCompanyNotFound() {
        ...
        AuthenticatedProfileResponse result =
                meController.profile(buildJwt("auth0|co4", "c@c.com"));

export function ProjectDetailsSkeleton() {
  return (
    <>
    <article
      className="bg-white rounded-2xl shadow-[var(--shadow-vinculo)] px-5 sm:px-8 py-6 sm:py-8 border border-slate-200 animate-pulse"
      aria-busy="true"
    ...
    >
      ...
      <div className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 gap-8">
    ...
    <div className="mt-6 bg-white rounded-2xl shadow-[var(--shadow-vinculo)] px-5 sm:px-8 py-6 sm:py-8 border border-slate-200 animate-pulse">
